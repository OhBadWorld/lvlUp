<template>
  <div>
    ...
    <div style="margin: 10px 10px 0px 20px;">
      <span style="font-size: 14px;">参与水质评价因子：</span>
      <el-select v-model="factorVal" placeholder="请选择" style="margin-left: 10px;" class="searchSel" >
        <el-option
    ...
    <div style="height: calc(100vh - 520px);overflow-x: hidden;overflow-y: auto;">
      <div>
        <div style="margin: 10px;" class="dataTable">
          <el-table border height="326"
...
::v-deep .searchSel .el-input__inner{
  height: 32px;
}
::v-deep .searchSel .el-input__icon{
  line-height: 32px;
}
